 ...
 * @author  Tim Barr, David Bartlett
 * @version 1.0.1
 ...
 *
 * Updated by David Bartlett, Omnisense Ltd, (c) 2016
 **/
 
/*
 * Adapted by Omnisense Ltd for use in the Omnisense geolocation application
 * November 2016
 */
...
public:
  ...
  /**
   ...
   enum ACQUISITION_TIMER
    ...
    /**
    * @enum INT1_CONFIGURATION
    * @brief Polarity and pin modes for Interrupt 1
    */
    enum INT1_CONFIGURATION
    {
        INT1_LOWPP  = 0x00,
    ...
    /**
    * @enum INT2_CONFIGURATION
    * @brief Polarity and pin modes for Interrupt 2
    */
    enum INT2_CONFIGURATION
    {
        INT2_LOWPP  = 0x00,
    ...
    /**
    * @enum INT_ENABLES
    * @brief Interrupt enable bit mapping - enabled interrupts are routed to the MAPPING pin
    */
    enum INT_ENABLES
    {
        INT_EN_DRDY     = 0x80,
    ...
    /**
    * @enum INT_MAPPING
    * @brief Interrupt set here are mapped to INT1, otherwise INT2
    */
    enum INT_MAPPING
    {
        INT_CFG_DRDY     = 0x80,
    ...
    /** Configure interrupt settings in the chip
    *   @param int1PinMode  - sets the interrupt pin polarity and mode
    *   @param int2PinMode  - sets the interrupt pin polarity and mode
    *   @param intMapping   - maps interrupt sources to the physical pins
    *   @param intEnable    - enable interrupt sources
    */
    uint8_t setInterrupts(INT1_CONFIGURATION iconfig1, INT2_CONFIGURATION iconfig2,
                INT_MAPPING intmap, INT_ENABLES intenable);
